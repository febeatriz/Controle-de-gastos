...
function CardInvestimentos({ total, lista, onExcluir }) {
    ...
    return (
        <div className="bg-despesa p-4 sm:p-5 rounded-xl mb-4 sm:mb-5 text-center bg-violet-400 max-w-full mx-4 sm:mx-0 ">
            ...
            <div className="mt-2 sm:mt-3">
                {itens.length === 0 && <p className="text-gray-900 text-sm sm:text-base">Nenhum investimento</p>}

                {itens.map((t) => (
                    <div key={t.id} className="grid grid-cols-[50px_1fr_80px_25px] sm:grid-cols-[70px_1fr_120px_30px] gap-1 sm:gap-2 sm:text-sm md:text-base py-1 px-2 items-center border-b border-white border-opacity-10">
